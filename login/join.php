...
if (isset($_POST["user"])){
    ...
    else
    {
        ...
        else
        {
            ...
            $sql2="INSERT INTO users (`userid`,`userpass`,`usertoken`) VALUES ('$user','$password','')";
            ...
            {
                //setcookie("user",$user);
                echo "<script>alert('注册成功');window.location='http://flyzhangyx.com';</script>";
            }
...
<div class='adds'>
	<form name='add' action='join.php' method='post'>
		<span>账号</span><br>
		<input type='text' name='user' placeholder='输入您的手机号' id='account'><br>
		<span>密码</span><br>
